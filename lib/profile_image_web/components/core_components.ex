defmodule ProfileImageWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ProfileImageWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ProfileImageWeb.Gettext, "errors", msg, opts)
    end
  end
