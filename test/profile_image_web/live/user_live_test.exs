defmodule ProfileImageWeb.UserLiveTest do
  use ProfileImageWeb.ConnCase

  import Phoenix.LiveViewTest
  import ProfileImage.AccountsFixtures

  @create_attrs %{descrption: "some descrption", username: "some username"}
  ...
  describe "Index" do
    ...
    test "updates user in listing", %{conn: conn, user: user} do
      ...
      assert html =~ "some updated descrption"
    end
